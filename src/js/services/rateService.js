...
RateService.prototype._fetchCurrencies = function() {
  ...
  var rateServiceUrl = 'http://insight.p90.ducatus.io/api/rates';
...
RateService.prototype.toFiat = function(satoshis, code) {
  ...
  return satoshis * this.SAT_TO_DTC * this.getRate(code);
};
...
RateService.prototype.fromFiat = function(amount, code) {
  ...
  return amount / this.getRate(code) * this.DTC_TO_SAT;
};
