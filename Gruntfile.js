...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    exec: {
      ...
      desktopsign: {
        cmd: 'gpg -u 7E460B7D22AC8C8F4678B704EDE32DCE3066021E --output webkitbuilds/<%= pkg.title %>-linux.zip.sig --detach-sig webkitbuilds/<%= pkg.title %>-linux.zip ; gpg -u 7E460B7D22AC8C8F4678B704EDE32DCE3066021E --output webkitbuilds/<%= pkg.title %>.exe.sig --detach-sig webkitbuilds/<%= pkg.title %>.exe'
      },
      desktopverify: {
      ...
      osxsign: {
        cmd: 'gpg -u 7E460B7D22AC8C8F4678B704EDE32DCE3066021E --output webkitbuilds/<%= pkg.title %>.dmg.sig --detach-sig webkitbuilds/<%= pkg.title %>.dmg'
      },
    },
    watch: {
      options: {
          ...
          'CFBundleURLTypes': [
            {
              ...
              'CFBundleURLSchemes': ['ducatuscoin', '<%= pkg.name %>']
            }
          ]
        }
      },
